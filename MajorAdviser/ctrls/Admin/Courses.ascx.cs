    ...
    public partial class Courses : System.Web.UI.UserControl
    {
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Add")
            {
                ...
                SqlDataSource1.InsertParameters["description"].DefaultValue = ((TextBox)GridView1.FooterRow.FindControl("NewDescription")).Text;
                SqlDataSource1.InsertParameters["creditHours"].DefaultValue = ((TextBox)GridView1.FooterRow.FindControl("NewCreditHours")).Text;
                try
                {
